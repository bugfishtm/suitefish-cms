...
#		
#		File Description:
#			- Files with name worker.*.bash in this folder will be 
#				loaded if executed via background worker function.
...
mkdir /suitefish-test
touch /suitefish-test/site.extension.worker.example.bash
