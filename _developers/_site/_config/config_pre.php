<?php
	...
	*/ if(!is_array(@$object)) { http_response_code(404); Header("Location: ../"); exit(); }
	...
	/////////////////////////////////////////////////////////////////////////////
		...
		# Refer to another Page on activation
		// define("_HIVE_ACTION_ACT_DEFER_", false);
		# Refer to another Page on register
		// define("_HIVE_ACTION_REGISTER_DEFER_", false);
		# Refer to another Page on register
		// define("_HIVE_ACTION_REGISTER_DEFER_", false);
		# Refer to another Page on recover
		// define("_HIVE_ACTION_RECOVER_DEFER_", false);
		# Refer to another Page on mail change
		// define("_HIVE_ACTION_MAILCHANGE_DEFER_", false);
		# Refer to another Page on logout
		// define("_HIVE_ACTION_LOGOUT_DEFER_", false);
		# Refer to another Page on login
		// define("_HIVE_ACTION_LOGIN_DEFER_", false);
		# Refer to another Page on language change
		// define("_HIVE_ACTION_LANG_DEFER_", false);
