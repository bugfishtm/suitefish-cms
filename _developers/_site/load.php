	...
	*/ if(!is_array(@$object)) { http_response_code(404); Header("Location: ../"); exit(); }
	?>
		<?php
			...
			hive__default_volt_header($object, "Site Example", '<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1" /><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><link rel="icon" type="image/x-icon" href="'._HIVE_URL_REL_.'/_core/_image/favicon.ico"><meta name="robots" content="noindex, nofollow">', "dark");
		?>		
		<style>
			/*-----------------------------------------*/
				...
				<div class="col-12 d-flex align-items-center justify-content-center">
					<div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
						...
						<div class="containerbox">
								...
								<br><br>
								<?php echo "<a href='"._HIVE_URL_REL_."/_user/user_switch.php' rel='noopener' class='btn btn-primary'>Switch to Backend</a> "; ?>
								<br><br>
						</div>		
