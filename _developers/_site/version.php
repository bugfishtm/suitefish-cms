<?php
	...
	*/  $x = array();
	...
	##############################
		...
		$x["name"] 			= "Template: Site Module";
		
		// Module Description 
		// Description for the Module with informations for the store or internal sites.
		$x["description"] = "The _tplsite module provides a basic template to demonstrate the structure of full site modules in Suitefish CMS. It showcases minimal responsive design principles.";
