...
##########################################################################################
var_password=Defina una contraseña para ser creada durante la configuración del contenedor para el acceso a la base de datos MySQL.
var_user=Defina un nombre de usuario para ser creado durante la configuración del contenedor para el acceso a la base de datos MySQL.
var_port=Defina un puerto para la instancia de MySQL en el sistema host.
