<?php
	...
	*/  $x = array();
	...
	##############################
		...
		// Available Languages 
		// Available Languages in this Module Array (Default Languages: array("en", "de", "fr", "it", "es", "zn", "ja"))
		$x["lang"] 			= array("en", "de", "fr", "it", "es", "zn", "ja");
		...
		$x["description"] = "This example module demonstrates the functioning of Image Module extensions within this CMS. It includes readme files explaining the use of various folders and provides a skeleton template for creating your own image modules.";
