...
|------------------------------------|--------------------------------------|
| `./MODNAME/`            | Folder for cached files of site module 'MODNAME'.  |
| `./MODNAME/__extension`      | Folder for cached files of site module 'MODNAME' extensions.            |
| `./MODNAME/__extension/EXTNAME`      | Folder for cached files of site module 'MODNAME' extension 'EXTNAME'.            |
