						...
						<div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
							...
							<div class="d-flex justify-content-center align-items-center mt-4">
								<span class="fw-normal">
									<a href="<?php echo _HIVE_URL_REL_; ?>_user/user_recover.php"  class="btn btn-gray-200 mt-2"><?php echo $object["lang"]->translate("hive_login_recoveraccount"); ?></a>
								</span>
							</div>
						</div>
					</div>
						...
						<form action="./user_recover.php<?php echo $formext; ?>" class="mt-4" method="post">
							...
							<div class="form-group mb-4">
								...
								<div class="input-group">
									...
									<input type="text" name="mail" class="form-control" value="<?php echo htmlentities(@$_POST["mail"] ?? ''); ?>" autocomplete="off" placeholder="<?php echo hive__hen($object["lang"]->translate("string_email")); ?>" id="email" autofocus required>
								</div>  
							</div>
								<?php }  ?>
							</div>
							<div class="d-grid">
								...
								<?php if(defined("_HIVE_ENABLESITE_LOGIN_")) { if(_HIVE_ENABLESITE_LOGIN_) { ?> <a href="./user_login.php" class="btn btn-gray-200 mt-2"><?php echo $object["lang"]->translate("hive_login_backtologin"); ?></a> <?php } } ?>
