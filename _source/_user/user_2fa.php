				...
				<div class="col-12 d-flex align-items-center justify-content-center">
					<div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
						<div class="text-center text-md-center mb-4 mt-md-0">
							<h1 class="mb-0 h3"><?php echo $object["lang"]->translate("string_2fa"); ?></h1>
							...
							<?php } ?>
							<p><?php echo $object["lang"]->translate("hive_login_msg_2fa"); ?></p>
						</div>
						<form action="./user_2fa.php<?php echo $formext; ?>" class="mt-4" method="post">
							...
							<div class="form-group">
								...
								<div class="form-group mb-4">
									<label for="email"><?php echo $object["lang"]->translate("string_url"); ?></label>
									<div class="input-group">
							...
							<div class="d-grid">
							<?php if($uses_2fa) { ?>
								<button type="submit" class="btn btn-gray-800"><?php echo $object["lang"]->translate("string_disable"); ?></button> 
							<?php } else { ?>
								<button type="submit" class="btn btn-gray-800"><?php echo $object["lang"]->translate("string_enable"); ?></button>  
							<?php } ?>
