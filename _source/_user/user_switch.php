        ...
        <article><div class="card">
            <h1>Backend/Frontend Switch</h1>
				...
				<?php if($is_admin) { 
					...
					?>
						<input type="submit" value="<?php echo hive__hen($object["lang"]->translate("hive_login_mc_backtohome")); ?>" name="adm_change_access" class="btn"> <a href="../" class="btn"><?php echo hive__hsc($object["lang"]->translate("hive_login_mc_backtohome")); ?></a><br />
					</form>
				<?php } else { 
					if(@$_GET["adm_change_access"]) {
