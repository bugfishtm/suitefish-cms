<?php
	...
	*/
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Language Change Functionalitites
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	$object["csrf"] = new x_class_csrf(_HIVE_SITE_COOKIE_."__login_csrf_lang");
				...
				<div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
					...
					<div class="form-group mb-4">
						<?php foreach(_HIVE_LANG_ARRAY_ as $key => $value) { ?>	
							<a class="d-flex align-items-center" href="./user_language.php?change=<?php echo htmlspecialchars($value ?? ''); ?>">
							 <div><?php 
					...
					<div class="d-grid">
						<?php if(defined("_HIVE_ENABLESITE_LOGIN_") AND !$object["user"]->user_loggedIn) { if(_HIVE_ENABLESITE_LOGIN_) { ?> <a href="./user_login.php" class="btn btn-gray-200 mt-2"><?php echo $object["lang"]->translate("hive_login_backtologin"); ?></a> <?php } } ?>
