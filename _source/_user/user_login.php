<?php
	...
	*/
	...
	if(defined("_HIVE_ACTION_LOGIN_DEFER_")) {
		if(_HIVE_ACTION_LOGIN_DEFER_) {
			Header("Location: "._HIVE_ACTION_LOGIN_DEFER_."");
			exit();
		}
	}
                            ...
                            <form action="#" class="mt-4" method="post">
                                    ...
                                    <div class="d-flex justify-content-between align-items-top mb-4">
										...
										<?php if(defined("_HIVE_ACTION_RECOVER_")) { ?>
											<?php if(_HIVE_ACTION_RECOVER_) { ?>
												<div><a href="<?php echo _HIVE_URL_REL_; ?>_core/_action/user_recover.php" class="small text-right"><?php echo $object["lang"]->translate("hive_login_lostpass"); ?></a></div>
											<?php } ?>
										<?php } ?>
									</div>
                                </div>
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-gray-800"><?php echo $object["lang"]->translate("string_login"); ?></button>
										<?php if(defined("_HIVE_ACTION_REGISTER_")) { if(_HIVE_ACTION_REGISTER_) { ?> <a href="<?php echo _HIVE_URL_REL_; ?>_core/_action/user_register.php" class="btn btn-gray-200 mt-2"><?php echo $object["lang"]->translate("string_register"); ?></a> <?php } } ?>
                                    <a href="<?php echo _HIVE_URL_REL_; ?>" class="btn btn-gray-200 mt-2"><?php echo $object["lang"]->translate("hive_login_mc_backtohome"); ?></a>
                                </div>
                            </form>
							<?php if(defined("_HIVE_LANG_ARRAY_")) {if(is_array(_HIVE_LANG_ARRAY_)) { ?>
									<span class="fw-normal mt-0 pt-2 mb-0 pb-0">
									   <?php echo $object["lang"]->translate("hive_login_changelanguage"); ?>
										<a href="<?php echo _HIVE_URL_REL_; ?>_core/_action/user_language.php" class="fw-bold"><?php echo $object["lang"]->translate("hive_login_changelanguage_here"); ?></a>
									</span>
							<?php }} ?>
                        </div>
                    </div>
