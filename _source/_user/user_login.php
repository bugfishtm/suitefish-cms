					...
					<div class="row justify-content-center form-bg-image" > <!-- data-background-lg="../../assets/img/illustrations/signin.svg"-->
						<div class="col-12 d-flex align-items-center justify-content-center">
							<div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
								<?php echo $object["lang"]->translate("hive_cannotenterwhilelogin"); ?>
			...
			<section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
				<div class="container mb-5">
					<div class="row justify-content-center form-bg-image" > <!-- data-background-lg="../../assets/img/illustrations/signin.svg"-->
						<div class="col-12 d-flex align-items-center justify-content-center">
							<div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
								<?php echo $object["lang"]->translate("hive_login_msg_ipban"); ?>
								<br /><br /><a href="../"  class="btn btn-gray-200 mt-2"><?php echo $object["lang"]->translate("hive_login_mc_backtohome"); ?></a>
							</div>
						</div>
					</div>
                            ...
                            <form action="#" class="mt-4" method="post">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="usermail"  autocomplete="off" class="form-control" value="<?php echo htmlentities(@$_POST["usermail"] ?? ''); ?>" placeholder="<?php echo hive__hen($object["lang"]->translate("string_email")); ?>" id="email" autofocus required>
                                    </div>  
                                </div>
                                <!-- End of Form -->
                                <div class="form-group">
                                    ...
                                    <!-- Form -->
                                    <div class="form-group mb-4">
                                        <label for="password"><?php echo $object["lang"]->translate("hive_login_msg_2fa_request"); ?></label>
                                        <div class="input-group">
                                            <span class="input-group-text" id="basic-addon2">
                                                <svg class="icon icon-xs text-gray-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"></path></svg>
                                            </span>
                                            <input type="text"  autocomplete="off" placeholder="<?php echo hive__hen($object["lang"]->translate("hive_login_msg_2fa_request")); ?>" class="form-control" id="password" name="password2fa">
                                        </div>  
                                    </div>
                                    <!-- End of Form -->
                                    <div class="d-flex justify-content-between align-items-top mb-4">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label mb-0" for="remember">
                                              <?php echo $object["lang"]->translate("hive_login_rememberme"); ?>
                                            </label>
										</div>
										<?php if(defined("_HIVE_ENABLESITE_RECOVER_")) { ?>
											<?php if(_HIVE_ENABLESITE_RECOVER_) { ?>
												<div><a href="<?php echo _HIVE_URL_REL_; ?>_user/user_recover.php" class="small text-right"><?php echo $object["lang"]->translate("hive_login_lostpass"); ?></a></div>
											<?php } ?>
										<?php } ?>
									</div>
                                </div>
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-gray-800"><?php echo $object["lang"]->translate("string_login"); ?></button>
										<?php if(defined("_HIVE_ENABLESITE_REGISTER_")) { if(_HIVE_ENABLESITE_REGISTER_) { ?> <a href="<?php echo _HIVE_URL_REL_; ?>_user/user_register.php" class="btn btn-gray-200 mt-2"><?php echo $object["lang"]->translate("string_register"); ?></a> <?php } } ?> 
                                    <a href="<?php echo _HIVE_URL_REL_; ?>" class="btn btn-gray-200 mt-2"><?php echo $object["lang"]->translate("hive_login_mc_backtohome"); ?></a>
                                </div>
                            </form>
							<?php if(defined("_HIVE_ENABLESITE_LANGCHANGE_")) {if(_HIVE_ENABLESITE_LANGCHANGE_) { ?>
									<span class="fw-normal mt-0 pt-2 mb-0 pb-0">
									   <?php echo $object["lang"]->translate("hive_login_changelanguage"); ?>
										<a href="<?php echo _HIVE_URL_REL_; ?>_user/user_language.php" class="fw-bold"><?php echo $object["lang"]->translate("hive_login_changelanguage_here"); ?></a>
									</span>
							<?php }} ?>
                        </div>
                    </div>
