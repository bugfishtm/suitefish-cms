					...
					<div class="row justify-content-center form-bg-image" > <!-- data-background-lg="../../assets/img/illustrations/signin.svg"-->
						<div class="col-12 d-flex align-items-center justify-content-center">
							<div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
								...
								<br /><br /><a href="../"  class="btn btn-gray-200 mt-2"><?php echo $object["lang"]->translate("hive_login_mc_backtohome"); ?></a>
							</div>
						</div>
					</div>
				</div>
        ...
        <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center mb-4">
            <div class="container mb-5">
                <div class="row justify-content-center form-bg-image" > <!-- data-background-lg="../../assets/img/illustrations/signin.svg"-->
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
							<?php echo $object["lang"]->translate("hive_cannotenterwhilenologin"); ?>
							<br /><br /><a href="../" class="btn btn-gray-200 mt-2"><?php echo $object["lang"]->translate("hive_login_mc_backtohome"); ?></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h3"><?php echo $object["lang"]->translate("string_change_password"); ?></h1>
								<?php if($object["user"]->login_as_is()) { ?>
									<div class="alert alert-danger"><?php echo $object["lang"]->translate("hive_login_msg_passc_loginasact"); ?></div>
								<?php } ?>
                            </div>
                            ...
                            <form action="./user_pass_change.php" class="mt-4" method="post">
								...
								<div class="form-group mb-4">
									<label for="password"><?php echo $object["lang"]->translate("string_current_password"); ?></label>
                                ...
                                <!-- Form -->
								<div class="form-group mb-4">
									<label for="password"><?php echo $object["lang"]->translate("string_new_password"); ?></label>
									<div class="input-group">
										<span class="input-group-text" id="basic-addon2">
											<svg class="icon icon-xs text-gray-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"></path></svg>
										</span>
								...
								<!-- Form -->
								<div class="form-group mb-4">
									<label for="password"><?php echo $object["lang"]->translate("string_confirm_new_password"); ?></label>
									<div class="input-group">
										<span class="input-group-text" id="basic-addon2">
											<svg class="icon icon-xs text-gray-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"></path></svg>
										</span>
                                ...
                                <div class="d-grid">
									<button type="submit" class="btn btn-gray-800"><?php echo $object["lang"]->translate("string_change_password"); ?></button>
