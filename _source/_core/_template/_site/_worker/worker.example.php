<?php
	...
	*/ 
	...
	// optional but recommended, otherwhise wrong data may be loaded up
	...
	if(file_exists(dirname(__FILE__)."/../../../settings.php")) { 
		...
		if ($object["mysql"]->lasterror == false) {
			...
			$object["var_glob"]->set("___smd__site_example", date("Y-m-d H:i"), "Just an example Worker Script Variable", true, true);
