<?php
	/* 
		...
		File Description:
			- Site Content injections if clicked on navigation or topbar menue.
	...
	*/ if(!is_array(@$object)) { http_response_code(404); Header("Location: ../"); exit(); }
	...
	if(hive__access($object, array($object["extension"]["prefix_variables"]."admin"), false)) { 
		...
		echo sf__theme_title(hive__hsc($object["extension"]["lang"]->translate("site_title")), hive__hsc($object["extension"]["lang"]->translate("site_heading_text")));
		...
		echo hive__hsc($object["extension"]["lang"]->translate("site_has_access"));
