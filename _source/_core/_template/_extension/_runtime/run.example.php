<?php
	...
	*/
	...
	// Operation here, settings is NOT included and no libraries initialized.
	// Below you see how an example could look like. 
	// It is recommended to look up official modules for more examples on these files
	// to stay compliant to coding rules.
	// Look suitefish repositories at: https://github.com/bugfishtm
	
	// Prevent Initialization if Settings.php is included. 
	// Recommended to prevent wrong data fetches and heap on performance
	...
	if(file_exists(dirname(__FILE__)."/../../../../../settings.php")) {
		...
		// Strictly recommended for security reasons!
