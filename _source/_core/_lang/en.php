...
hive_var-_HIVE_ENABLESITE_MAILCHANGE_=Enable the Default CMS User Mail change Site?
hive_var-_HIVE_ENABLESITE_PASSCHANGE_=Enable the Default CMS User Password change Site?
hive_var-_HIVE_ENABLESITE_RECOVER_=Enable the Default CMS User Recover Site?
hive_var-_HIVE_ENABLESITE_LOGIN_=Enable the Default CMS User Login Site?
hive_var-_HIVE_ENABLESITE_LOGOUT_=Enable the Default CMS User Logout Site?
hive_var-_HIVE_ENABLESITE_REGISTER_=Enable the Default CMS User Register Site?
hive_var-_HIVE_ENABLESITE_LANGCHANGE_=Enable the Default CMS Language Switch Site?
hive_var-_HIVE_ENABLESITE_MODESWITCH_=Enable the Default CMS Frontend/Backend Switch Site?
hive_var-_HIVE_ENABLESITE_2FA_=Enable the Default CMS User 2FA Site?
hive_var-_HIVE_ENABLESITE_ACTIVATE_=Enable the Default CMS User Activation Site?
hive_var-_HIVE_LANG_DEFAULT_=Default Language.
hive_var-_REDIS_=Redis activation status.
hive_var-_REDIS_HOST_=Redis Host.
hive_var-_REDIS_PORT_=Redis Port.
hive_var-_SMTP_MAILS_HEADER_=Default E-Mail Header.
hive_var-_SMTP_MAILS_FOOTER_=Default E-Mail Footer.
hive_var-_SMTP_SENDER_MAIL_=Default sender mail.
hive_var-_SMTP_SENDER_NAME_=Default sender name.
hive_var-_SMTP_MAILS_IN_HTML_=Send E-Mails in html?
hive_var-_SMTP_INSECURE_=Allow insecure server connections?
hive_var-_SMTP_DEBUG_=E-Mail Debug Status. (0-3)
hive_var-_SMTP_HOST_=E-Mail Host.
hive_var-_SMTP_PORT_=E-Mail Port.
hive_var-_SMTP_AUTH_=E-Mail Authentication Method.
hive_var-_SMTP_USER_=E-Mail Username.
hive_var-_SMTP_PASS_=E-Mail Password.
hive_var-_USER_MAX_SESSION_=Session Expire Date in Days.
hive_var-_USER_TOKEN_TIME_=User Token Expire Time in Minutes.
hive_var-_USER_AUTOBLOCK_=Auto Block users after a specific amount of failed logins.
hive_var-_USER_WAIT_COUNTER_=Time for users to wait between recover and activation/register requests in minutes.
hive_var-_USER_LOG_SESSIONS_=Log expired sessions in database?
hive_var-_USER_LOG_IP_=Log IPs in database?
hive_var-_USER_PF_SIGNS_=Password Filter: Requires signs at least.
hive_var-_USER_PF_CAPSIGNS_=Password Filter: Capital letters at least.
hive_var-_USER_PF_SMSIGNS_=Password Filter: Small letters at least.
hive_var-_USER_PF_SPSIGNS_=Password Filter: Special signs at least.
hive_var-_USER_PF_NUMSIGNS_=Password Filter: Numeric signs at least.
hive_var-_UPDATER_CODE_=Code require to run the update manager? (can be overwritten by ruleset.cfg)
hive_var-_HIVE_CURL_LOGGING_=Activate Curl Logging?
hive_var-_HIVE_IP_LIMIT_=Blacklisting Limit of failures for IPs before getting blocked.
hive_var-_HIVE_REFERER_=Enable Referer Logging Functionality?
hive_var-_HIVE_CSRF_TIME_=Time in seconds CSRF Tokens for forms are valid.
...
hive_var-_HIVE_TITLE_SPACER_=Default Website Tab Spacer.
hive_var-_HIVE_PHP_DEBUG_=Activate PHP Debug Mode?
hive_var-_HIVE_MYSQL_DEBUG_=Activate MySQL Debug Mode?
