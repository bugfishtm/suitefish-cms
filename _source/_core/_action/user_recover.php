                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" placeholder="<?php echo $object["lang"]->translate("hive_login_password_confirm"); ?>" class="form-control" id="password" name="password_confirm" required>
                                        </div>  
                                    </div>
									<?php } else {  ?>
                                <!-- Form -->
