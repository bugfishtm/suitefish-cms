...
The _store folder manages cache files for items downloaded from the internal store and files used for deploying modules, core versions, or software through the CMS. It stores deployed files, including core, module, and software releases. The API to fetch store data content is located at /_api/v1.php.
