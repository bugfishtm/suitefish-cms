<?php
	/* 
		...
		File Description:
			Main CMS Loader File to Initialize CMS and Load Current 
			Located Site and Website Module, includes the installer. 
	*/
	...
	if(file_exists("./settings.php")) {
		//////////////////////////////////////////////////////
		// We expect already success installation
		//////////////////////////////////////////////////////
		...
		//////////////////////////////////////////////////////
		// Check if frontpage is blocked due to blockage.
		//////////////////////////////////////////////////////				
		if(defined("_HIVE_BLOCK_FP_")) {
			if(_HIVE_BLOCK_FP_) {
				hive__error("Blocked", 'This website serves currently no public use.', "", true, 200, false, "cog");
				exit();
			}		
		}	
		...
		if(file_exists($object["path"]."/_site/"._HIVE_MODE_."/load.php")) {
			...
			if(!defined("_HIVE_DEFINE_TO_PREVENT_BENCHMARK_")) { $object["benchmark"]->execute($object["mysql"]->benchmark_get()); } 
			if(!defined("_HIVE_DEFINE_TO_PREVENT_HITCOUNTER_")) { $object["hitcounter"]->execute(); } 
		} else { 
					...
					<?php
						...
						if (function_exists('apache_get_version')) {
							...
							if (strpos($apacheVersion, 'Apache/2') === 0) {
								echo "<font color='green'>&#10003;</font> Apache2 version is 2.x.";
							} else {
								echo "<font color='red'>&#10060;</font> - Apache version is not 2.x like expected.";
							}
						} else {
							echo "<font color='blue'>&#9888;</font> Unable to verify active apache2 version to be 2.x.";
						}
					?><br />
					<?php
						// Check if the Apache server is running
						if (function_exists('apache_get_modules')) {
							if (in_array('rewrite_module', apache_get_modules())) {
								echo "<font color='green'>&#10003;</font> The Apache mod_rewrite module is loaded.";
							} else {
								echo '<font color=\'red\'>&#10060;</font> - The Apache mod_rewrite module is not loaded.';
							}
						} else {
							echo "<font color='blue'>&#9888;</font> Unable to verify active mod_rewrite for apache2.";
						}
					?>	<br />
					<?php 
						// Get the PHP version
						...
						if ($major_version === 8) {
							echo "<font color='green'>&#10003;</font> PHP version is 8.x.";
						} else {
							echo "<font color='red'>&#10060;</font> Please upgrade or downgrade the PHP version for this website to 8.x.";
						}			
					?>		<br />
					<?php
						// Check if the Apache server is running
						if (function_exists('extension_loaded')) {
							if (extension_loaded('mysqli')) {
								echo '<font color=\'green\'>&#10003;</font> The PHP mysqli extension is loaded.';
							} else {
								echo '<font color=\'red\'>&#10060;</font> The PHP mysqli extension is not loaded.';
							}
						} else {
					...
					<?php
						...
						if (function_exists('extension_loaded')) {
							if (extension_loaded('xml')) {
								echo '<font color=\'green\'>&#10003;</font> The PHP xml extension is loaded.';
							} else {
								echo '<font color=\'red\'>&#10060;</font> The PHP xml extension is not loaded.';
							}
						} else {
					...
					<?php
						...
						if (function_exists('extension_loaded')) {
							if (extension_loaded('mbstring')) {
								echo '<font color=\'green\'>&#10003;</font> The PHP mbstring extension is loaded.';
							} else {
								echo '<font color=\'red\'>&#10060;</font> The PHP mbstring extension is not loaded.';
							}
						} else {
					...
					<?php
						...
						if (function_exists('extension_loaded')) {
							if (extension_loaded('curl')) {
								echo '<font color=\'green\'>&#10003;</font> The PHP curl extension is loaded.';
							} else {
								echo '<font color=\'red\'>&#10060;</font> The PHP curl extension is not loaded.';
							}
						} else {
					...
					<?php
						...
						if (function_exists('extension_loaded')) {
							if (extension_loaded('zip')) {
								echo '<font color=\'green\'>&#10003;</font> The PHP zip extension is loaded.';
							} else {
								echo '<font color=\'red\'>&#10060;</font> The PHP zip extension is not loaded.';
							}
						} else {
					...
					<?php
						...
						if (function_exists('extension_loaded')) {
							if (extension_loaded('ctype')) {
								echo '<font color=\'green\'>&#10003;</font> The PHP ctype extension is loaded.';
							} else {
								echo '<font color=\'red\'>&#10060;</font> The PHP ctype extension is not loaded.';
							}
						} else {
					...
					<?php
						...
						if (function_exists('extension_loaded')) {
							if (extension_loaded('filter')) {
								echo '<font color=\'green\'>&#10003;</font> The PHP filter extension is loaded.';
							} else {
								echo '<font color=\'red\'>&#10060;</font> The PHP filter extension is not loaded.';
							}
						} else {
					...
					<?php
						...
						if (function_exists('extension_loaded')) {
							if (extension_loaded('json')) {
								echo '<font color=\'green\'>&#10003;</font> The PHP json extension is loaded.';
							} else {
								echo '<font color=\'red\'>&#10060;</font> The PHP json extension is not loaded.';
							}
						} else {
					...
					<?php
						...
						if (function_exists('extension_loaded')) {
							if (extension_loaded('intl')) {
								echo '<font color=\'green\'>&#10003;</font> The PHP intl extension is loaded.';
							} else {
								echo '<font color=\'red\'>&#10060;</font> The PHP intl extension is not loaded.';
							}
						} else {
					...
					<?php
						...
						if (function_exists('extension_loaded')) {
							if (extension_loaded('fileinfo')) {
								echo '<font color=\'green\'>&#10003;</font> The PHP fileinfo extension is loaded.';
							} else {
								echo '<font color=\'red\'>&#10060;</font> The PHP fileinfo extension is not loaded.';
							}
						} else {
					...
					<?php
						...
						if (function_exists('extension_loaded')) {
							if (extension_loaded('gd')) {
								echo '<font color=\'green\'>&#10003;</font> The PHP gd extension is loaded.';
							} else {
								echo '<font color=\'red\'>&#10060;</font> The PHP gd extension is not loaded.';
							}
						} else {
					...
					<?php
						...
						if (function_exists('extension_loaded')) {
							if (extension_loaded('bcmath')) {
								echo '<font color=\'green\'>&#10003;</font> The PHP bcmath extension is loaded.';
							} else {
								echo '<font color=\'red\'>&#10060;</font> The PHP bcmath extension is not loaded.';
							}
						} else {
					...
					<?php
						...
						if (function_exists('extension_loaded')) {
							if (extension_loaded('pdo')) {
								echo '<font color=\'green\'>&#10003;</font> The PHP pdo extension is loaded.';
							} else {
								echo '<font color=\'red\'>&#10060;</font> The PHP pdo extension is not loaded.';
							}
						} else {
