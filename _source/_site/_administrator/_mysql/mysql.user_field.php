<?php
	...
	*/ if(!is_array(@$object)) { @http_response_code(404); Header("Location: ../"); exit(); }	
	...
	$object["mysql"]->multi_query("CREATE TABLE IF NOT EXISTS `"._HIVE_SITE_PREFIX_."user_field` (
	  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique ID',
	  `field_key` varchar(128) NULL COMMENT 'Name of the Field for substitutions.',
	  `field_description` text NULL COMMENT 'Description of the Field.',
	  `field_setting` longtext NULL COMMENT 'Settings of this field key.',
	  `field_extension` varchar(128) NULL COMMENT 'Name of the extension this item belongs to.',
	  ...
	  UNIQUE KEY `unique_sf_user_field` (`field_key`, `field_extension`)
	);");