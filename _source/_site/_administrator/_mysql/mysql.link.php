<?php
	...
	*/ if(!is_array(@$object)) { @http_response_code(404); Header("Location: ../"); exit(); }	
	...
	$object["mysql"]->multi_query("CREATE TABLE IF NOT EXISTS `"._HIVE_SITE_PREFIX_."link` (
	  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique ID',
	  `link_from` int(10) NULL COMMENT 'From Preference',
	  `link_to` int(10) NULL COMMENT 'To Preference',
	  `link_type` varchar(64) NULL COMMENT 'Type',
	  
	  `field_setting` text NULL COMMENT 'Settings of this field key.',
	  `link_extension` varchar(128) NULL COMMENT 'Name of the extension this item belongs to.',
