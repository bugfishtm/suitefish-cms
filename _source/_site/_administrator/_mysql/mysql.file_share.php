<?php
	...
	*/ if(!is_array(@$object)) { @http_response_code(404); Header("Location: ../"); exit(); }	
		$object["mysql"]->multi_query("
			CREATE TABLE IF NOT EXISTS `"._HIVE_SITE_PREFIX_."file_share` (
			  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Unique ID',
			  `fk_user` int(10) DEFAULT NULL COMMENT 'User with Access',
			  `fk_share_by` int(10) DEFAULT NULL COMMENT 'User who provided share',
			  `fk_share_type` int(10) DEFAULT NULL COMMENT 'Share Permission Code',
			  `fk_group` int(10) DEFAULT NULL COMMENT 'Group with Access',
			  `fk_file` int(11) DEFAULT NULL COMMENT 'File for Access',
			  `fk_folder` int(11) DEFAULT NULL COMMENT 'Folder for Access',
