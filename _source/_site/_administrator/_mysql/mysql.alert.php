<?php
	...
	*/ if(!is_array(@$object)) { @http_response_code(404); Header("Location: ../"); exit(); }	
		$object["mysql"]->multi_query("
			CREATE TABLE IF NOT EXISTS `"._HIVE_SITE_PREFIX_."alert` (
			  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
			  `alert_text` text NOT NULL COMMENT 'Event Text',
			  `alert_url` text NOT NULL COMMENT 'Event URL',
			  `alert_read` int(1) DEFAULT 0 COMMENT 'Alert Read -1 | Alert Not Read - 0',
			  `fk_user` int(11) DEFAULT NULL COMMENT 'Event Owning User', 
