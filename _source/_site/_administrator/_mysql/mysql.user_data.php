<?php
	...
	*/ if(!is_array(@$object)) { @http_response_code(404); Header("Location: ../"); exit(); }	
	$object["mysql"]->multi_query("CREATE TABLE IF NOT EXISTS `"._HIVE_SITE_PREFIX_."user_data` (
	  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique ID',
	  `data_value` longtext NULL COMMENT 'Data Value',
	  `fk_user` int(11) NULL COMMENT 'Related User Item',
	  `fk_user_field` int(11) NULL COMMENT 'Related User Field',
	  ...
	  UNIQUE KEY `unique_sf_user_data` (`fk_user_field`, `fk_user`)
	);");