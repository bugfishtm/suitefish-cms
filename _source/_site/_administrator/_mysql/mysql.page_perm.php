<?php
	...
	*/ if(!is_array(@$object)) { @http_response_code(404); Header("Location: ../"); exit(); }	
	$object["mysql"]->multi_query("CREATE TABLE IF NOT EXISTS `"._HIVE_SITE_PREFIX_."page_perm` (
	  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique ID',
	  `fk_user` int(11) NULL COMMENT 'Related User',
	  `fk_group` int(11) NULL COMMENT 'Related Group',
	  `fk_page` int(11) NULL COMMENT 'Related Page',
	  ...
	  UNIQUE KEY `unique_sf_page_perm` (`fk_user`, `fk_group`, `fk_page`)
	);");