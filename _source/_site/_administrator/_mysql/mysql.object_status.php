<?php
	...
	*/ if(!is_array(@$object)) { @http_response_code(404); Header("Location: ../"); exit(); }	
	$object["mysql"]->multi_query("CREATE TABLE IF NOT EXISTS `"._HIVE_SITE_PREFIX_."object_status` (
	  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique ID',
	  `status_name` varchar(128) NULL COMMENT 'Status Name or Translation String',
	  `status_description` text NULL COMMENT 'Status Description or Translation String',
	  `status_color` varchar(8) NULL COMMENT 'Status Color Code',
	  `status_extension` varchar(128) NULL COMMENT 'Name of the extension this item belongs to.',
