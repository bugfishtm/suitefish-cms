<?php
	...
	*/ if(!is_array(@$object)) { @http_response_code(404); Header("Location: ../"); exit(); }	
	$object["mysql"]->multi_query("CREATE TABLE IF NOT EXISTS `"._HIVE_SITE_PREFIX_."object_data` (
	  `id` int NOT NULL AUTO_INCREMENT COMMENT 'Unique ID',
	  `data_value` longtext NULL COMMENT 'Data Value',
	  `fk_object_item` int(11) NULL COMMENT 'Related Object Item',
	  `fk_object_field` int(11) NULL COMMENT 'Related Field',
	  ...
	  UNIQUE KEY `unique_sf_object_data` (`fk_object_item`, `fk_object_field`)
	);");