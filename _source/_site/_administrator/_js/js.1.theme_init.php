	...
	if(isset($object["suitefish"]["theme"]["active"])) {
		if($object["suitefish"]["theme"]["active"] != "adminbsb") {
			if(function_exists("sf___override_file")) {
				$return = sf___override_file($object, "js.1.theme_init.php");
...
/********************************************************************************************/
/* Restricted AdminBSB Preload Code
/********************************************************************************************/
	...
	*/
	$.AdminBSB.leftSideBar = {
		activate: function () {
			...
			//Set Waves
			if (typeof Waves !== 'undefined') { Waves.attach('.menu .list a', ['waves-block']); }
	...
	*/
	...
	$.AdminBSB.dropdownMenu = {
		activate: function () {
			...
			//Set Waves
			if (typeof Waves !== 'undefined') { Waves.attach('.dropdown-menu li a', ['waves-block']); }
			if (typeof Waves !== 'undefined') { Waves.init(); }
		},
