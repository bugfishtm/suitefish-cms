<?php
	/* 
		...
		File Description:
			- If this js.0.debug.php js file is present in your site modules _js folder, the
				Website will log Javascript Errors at the corresponding table using a PHP Action.
	...
	if(isset($object["suitefish"]["theme"]["active"])) {
		if($object["suitefish"]["theme"]["active"] != "adminbsb") {
			if(function_exists("sf___override_file")) {
				$return = sf___override_file($object, "js.0.debug.php");
